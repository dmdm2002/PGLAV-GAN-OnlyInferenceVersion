...
from model.modules.attention import LocalMHA, ReAttention
...
class TransBlock(nn.Module):
    def __init__(self, in_features, out_features, rezero=True):
        ...
        self.local_attention = LocalMHA(dim=in_features, window_size=7, causal=True)
        self.re_attention = ReAttention(dim=in_features)
    ...
    def forward(self, x):
        ...
        l_attention = self.local_attention(y1)
        re_y, attn_next = self.re_attention(y1)
